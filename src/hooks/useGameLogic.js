...
export function useGameLogic(initialXpBase = 100, xpGrowth = 1.15) {
    ...
    useEffect(() => { handleRockClickRef.current = handleRockClick; }, [handleRockClick]);
    ...
    function purchaseUpgrade(upgradeId) {
        ...
        const updatedUpgrades = upgrades.map(upg => {
            ...
            if (upg.free) return upg; // Skip free upgrades in purchase.
    ...
    function claimOneLootBox() {
        setLootBoxes(prevLootBoxes => {
            ...
            } else if (loot.type === 'relaxation') {
                // Optionally apply bonus.
            }
    ...
    function handlePrestige() {
        ...
        setZenPoints(prev => prev + zenReward);
